...
const map_t J_p [] = {{8, 2, s_j1}, {8, 2, s_j2}, {8, 2, s_j3}, {8, 2, s_j4}};
...
const map_t L_p [] = {{8, 4, s_l1}, {8, 2, s_l2}, {8, 2, s_l3}, {8, 2, s_l4}};
...
const map_t T_p [] = {{8, 4, s_t1}, {8, 2, s_t2}, {8, 2, s_t3}, {8, 2, s_t4}};

const map_t null_shape [] = {{0, 0, NULL}};

// all the game shapes
const shape_t shapes [] = {{S_p, 2}, {Z_p, 2}, {I_p, 2}, {O_p, 1}, {J_p, 4}, {L_p, 4}, {T_p, 4}, {null_shape, 0}};
